...
void primero(int cant_palabras,string palabritas[]);
void segundo(int cant_palabras,string palabritas[]);
void tercero();
...
//    string len_inter[];
    ...
    primero(cant_palabras,palabritas);
    segundo(cant_palabras,palabritas);
}
